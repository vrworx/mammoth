...
## Changelog
* v.4.2.9\MAX_CHARS - 500 -> 1500

#### app/javascript/mastodon/features/compose/components/compose_form.jsx
---
[L103](https://github.com/mastodon/mastodon/blob/v4.2.9/app/javascript/mastodon/features/compose/components/compose_form.jsx#L103):
```javascript
return !(isSubmitting || isUploading || isChangingUpload || length(fulltext) > 1500 || (isOnlyWhitespace && !anyMedia));
```
[L300](https://github.com/mastodon/mastodon/blob/v4.2.9/app/javascript/mastodon/features/compose/components/compose_form.jsx#L300):
```javascript
...
---
[L4](https://github.com/mastodon/mastodon/blob/v4.2.9/app/validators/status_length_validator.rb#L4):
```ruby
MAX_CHARS = 1500
```
...
---
[L14](https://github.com/mastodon/mastodon/blob/v4.2.9/app/serializers/rest/instance_serializer.rb#L14):
```ruby
...
---
[L6](https://github.com/mastodon/mastodon/blob/v4.2.9/spec/validators/note_length_validator_spec.rb#L6):
```ruby
subject { described_class.new(attributes: { note: true }, maximum: 1500) }
```
[L9](https://github.com/mastodon/mastodon/blob/v4.2.9/spec/validators/note_length_validator_spec.rb#L9):
```ruby
